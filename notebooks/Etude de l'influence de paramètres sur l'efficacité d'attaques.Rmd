...
if exists(Config.DATA_PATH+'perfs_models_without_defense/perfs_global_small_model_'+str(name))==False:
    (SR_deepfool_1step_dic_small_model,SR_deepfool_mutliple_steps_dic_small_model,SR_FGSM_dic_small_model)=three_attacks_runner(small_model,small_model,X_test[:100], y_test[:100], epsilon_list)
    SR_blackbox_dic_small_model=boundary_attack_run(small_model,X_test[0],iterations=150)

    with open(Config.DATA_PATH+'perfs_models_without_defense/perfs_global_small_model_'+str(name), 'wb') as f:
...
if exists(Config.DATA_PATH+'perfs_models_without_defense/perfs_global_model_effnet_'+str(name))==False:
    (SR_deepfool_1step_dic_model_effnet,SR_deepfool_mutliple_steps_dic_model_effnet,SR_FGSM_dic_model_effnet)=three_attacks_runner(model_effnet,model_effnet,X_test[:100], y_test[:100], epsilon_list)
    SR_blackbox_dic_model_effnet=boundary_attack_run(small_model,X_test[0],iterations=150)
    with open(Config.DATA_PATH+'perfs_models_without_defense/perfs_global_model_effnet_'+str(name), 'wb') as f:
...
```{python}
with open(Config.DATA_PATH+'perfs_models_without_defense/perfs_global_small_model_Cifar', 'rb') as f:
...
with open(Config.DATA_PATH+'perfs_models_without_defense/perfs_global_small_model_Mnist', 'rb') as f:
